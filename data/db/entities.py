...
from sqlalchemy import (
    Integer, String, Text, JSON, BigInteger, Numeric, 
    Boolean, DateTime, ForeignKey, Index, func
)
...
class StockMetadata(Base):
    ...
    sectorKey: Mapped[Optional[str]] = mapped_column(String(150))
    sectorDisp: Mapped[Optional[str]] = mapped_column(String(150))
    industry: Mapped[Optional[str]] = mapped_column(String(150), index=True)
    industryKey: Mapped[Optional[str]] = mapped_column(String(150))
    industryDisp: Mapped[Optional[str]] = mapped_column(String(150))
    
    longBusinessSummary: Mapped[Optional[str]] = mapped_column(Text)
    fullTimeEmployees: Mapped[Optional[int]] = mapped_column(Integer)
    
    # Using JSON type; type hinting can be mapped to list or dict
    companyOfficers: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSON)
    executiveTeam: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSON)
    ...
    financialCurrency: Mapped[Optional[str]] = mapped_column(String(10))
    language: Mapped[Optional[str]] = mapped_column(String(20))
    region: Mapped[Optional[str]] = mapped_column(String(50))
    
    quoteType: Mapped[Optional[str]] = mapped_column(String(50))
    typeDisp: Mapped[Optional[str]] = mapped_column(String(50))
    messageBoardId: Mapped[Optional[str]] = mapped_column(String(100))
    exchangeTimezoneName: Mapped[Optional[str]] = mapped_column(String(100))
    exchangeTimezoneShortName: Mapped[Optional[str]] = mapped_column(String(20))
    gmtOffSetMilliseconds: Mapped[Optional[int]] = mapped_column(BigInteger)
    ...
    dynamic_data = relationship("DynamicData", back_populates="stock", cascade="all, delete-orphan")
    fundamental_data = relationship("FundamentalData", back_populates="stock", cascade="all, delete-orphan")
    analytic_data = relationship("AnalyticData", back_populates="stock", cascade="all, delete-orphan")
...
class DynamicData(Base):
    ...
    stock_id: Mapped[int] = mapped_column(ForeignKey("stock_market.metadata.stock_id", ondelete="CASCADE"), primary_key=True)
    ...
    regular_market_previous_close: Mapped[Optional[float]] = mapped_column(Numeric(15, 4))
    ...
    regular_market_change_percent: Mapped[Optional[float]] = mapped_column(Numeric(8, 4))
    ...
    fifty_two_week_low_change_percent: Mapped[Optional[float]] = mapped_column(Numeric(8, 4))
    ...
    fifty_two_week_high_change_percent: Mapped[Optional[float]] = mapped_column(Numeric(8, 4))
    fifty_two_week_change_percent: Mapped[Optional[float]] = mapped_column(Numeric(8, 4))
    
    fifty_day_average_change: Mapped[Optional[float]] = mapped_column(Numeric(15, 4))
    fifty_day_average_change_percent: Mapped[Optional[float]] = mapped_column(Numeric(8, 4))
    two_hundred_day_average_change: Mapped[Optional[float]] = mapped_column(Numeric(15, 4))
    two_hundred_day_average_change_percent: Mapped[Optional[float]] = mapped_column(Numeric(8, 4))
...
class FundamentalData(Base):
    ...
    price_to_sales_trailing_12_months: Mapped[Optional[float]] = mapped_column(Numeric(10, 4))
    ...
    trailing_annual_dividend_rate: Mapped[Optional[float]] = mapped_column(Numeric(15, 4))
    trailing_annual_dividend_yield: Mapped[Optional[float]] = mapped_column(Numeric(8, 4))
